<template>
  <div class="min-h-screen bg-white flex flex-col">
      ...
      <div class="max-w-md w-full text-center animate-fade-in">
        ...
        <div class="flex justify-center space-x-2 mb-12">
          <button
            ...
            :class="currentIndex === index ? 'w-8 h-2 bg-primary rounded-full' : 'w-2 h-2 bg-gray-300 rounded-full'"
          ></button>
        </div>
      </div>
    </div>
    ...
    <div class="p-6 space-y-3">
      ...
      <button 
        @click="skip"
        class="w-full text-center text-text-secondary hover:text-primary transition-colors py-3"
      >
        Skip
      </button>
    </div>
