  ...
  <PropertyLayout>
    ...
    <section class="relative bg-gray-50 py-8 md:py-12">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl">
          <h1 class="text-2xl sm:text-3xl font-bold mb-2 text-text-primary">My Trips</h1>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-primary">{{ upcomingBookings.length }}</p>
              </div>
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-primary">{{ loyaltyPoints }}</p>
              </div>
              <div class="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center">
                <svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-if="activeTab === 'upcoming'" class="space-y-6">
          <div v-if="upcomingBookings.length === 0" class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-text-primary mb-2">No upcoming trips</h3>
          ...
          <div v-else v-for="booking in upcomingBookings" :key="booking.id" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div class="flex flex-col md:flex-row gap-6">
              <img :src="booking.image" alt="Booking" class="w-full md:w-48 h-48 object-cover rounded-lg" />
              <div class="flex-1">
                <div class="flex items-start justify-between mb-4">
                  <div>
                    <h3 class="text-xl font-bold text-text-primary mb-2">{{ booking.name }}</h3>
                ...
                <div class="flex items-center justify-between">
                  <span class="text-2xl font-bold text-primary">{{ booking.price }} RWF</span>
                  <div class="flex gap-2">
                    <button class="px-4 py-2 border border-gray-300 text-text-primary rounded-lg hover:bg-gray-50 transition-colors">
                      View Details
                    </button>
                    <button class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-red-600 transition-colors">
                      Manage
                    </button>
                  </div>
                </div>
        ...
        <div v-if="activeTab === 'past'" class="text-center py-16">
          ...
          <h3 class="text-xl font-semibold text-text-primary mb-2">No past trips</h3>
        ...
        <div v-if="activeTab === 'saved'" class="space-y-6">
          <div v-if="watchlistCount === 0" class="text-center py-16">
            ...
            <h3 class="text-xl font-semibold text-text-primary mb-2">No saved items</h3>
