      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-text-muted text-sm mb-1 dark:text-gray-400">Saved</p>
                <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ watchlistCount }}</p>
              </div>
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-text-muted text-sm mb-1 dark:text-gray-400">Cart Items</p>
