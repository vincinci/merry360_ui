  ...
  <MainLayout>
    ...
    <section class="relative min-h-[400px] flex items-center justify-center overflow-hidden">
      <div class="absolute inset-0">
        ...
        />
        <div class="absolute inset-0 bg-gradient-to-r from-brand-600/90 to-brand-500/80"></div>
      </div>
      
      <div class="relative z-10 container mx-auto px-4 text-center text-white max-w-4xl">
        <h1 class="text-4xl md:text-6xl font-bold mb-6" style="font-family: 'Montserrat', sans-serif;">
    ...
    <section class="py-16 md:py-24 bg-white">
      <div class="container mx-auto px-4 max-w-7xl">
        ...
        <!-- Main Services Grid -->
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <!-- Accommodation Services -->
          <div class="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
          ...
          <div class="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <div class="p-6">
              <h3 class="text-xl font-bold mb-3 text-gray-900 dark:text-white">AI Concierge Service</h3>
              <p class="text-gray-600 dark:text-gray-300 text-sm mb-4">24/7 assistance powered by intelligent AI</p>
              <ul class="space-y-2 mb-6">
                <li class="flex items-start text-sm text-gray-700 dark:text-gray-200">
                  <svg class="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
          ...
          <div class="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <div class="p-6">
              <h3 class="text-xl font-bold mb-3 text-gray-900 dark:text-white">Property Management</h3>
              <p class="text-gray-600 dark:text-gray-300 text-sm mb-4">Maximize your property's potential with us</p>
              <ul class="space-y-2 mb-6">
                <li class="flex items-start text-sm text-gray-700 dark:text-gray-200">
                  <svg class="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
      ...
      <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div class="text-center">
            ...
            <h3 class="font-bold text-lg mb-2 dark:text-white">Trusted & Secure</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">Your safety and security are our top priorities</p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300">Get the best deals with no hidden fees</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="font-bold text-lg mb-2 dark:text-white">24/7 Support</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">Round-the-clock assistance whenever you need</p>
          </div>
          ...
          <div class="text-center">
            ...
            <h3 class="font-bold text-lg mb-2 dark:text-white">Local Expertise</h3>
            <p class="text-sm text-gray-600 dark:text-gray-300">Deep knowledge of Rwanda's hidden gems</p>
          </div>
        </div>
      </div>
    </section>
