  ...
  <PropertyLayout>
    ...
    <section class="bg-white border-b border-gray-200 py-8">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold text-text-primary">My Wishlist</h1>
    ...
    <section class="py-8">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div v-if="watchlist.length === 0" class="text-center py-12">
          ...
          <h3 class="text-lg font-semibold text-text-primary mb-2">No saved items</h3>
          <p class="text-sm text-text-secondary mb-4">Save your favorites to view them here</p>
          <button @click="router.push('/home')" class="px-4 py-2 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-red-600 transition-colors">
            Explore
          </button>
        </div>
        ...
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          >
            <div class="relative h-40">
              <img :src="item.image" :alt="item.name || item.title" class="w-full h-full object-cover" />
              <button 
            ...
            <div class="p-3">
              ...
              <div class="flex items-center justify-between">
                ...
                <button 
                  ...
                  class="px-3 py-1 bg-primary text-white rounded text-xs font-semibold hover:bg-red-600 transition-colors"
                >
                  Add to Cart
                </button>
              </div>
