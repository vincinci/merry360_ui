  ...
  <MainLayout>
      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 max-w-7xl mx-auto">
          <div class="flex-1 text-center md:text-left">
            <h2 class="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 text-gray-800 dark:text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 700; line-height: 1.3;">Download Our Mobile App</h2>
            <p class="text-sm md:text-base mb-6 md:mb-10 text-gray-600 dark:text-gray-300" style="font-family: 'Montserrat', sans-serif; font-weight: 500; line-height: 1.5;">Available for free on these platforms</p>
            <div class="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center md:justify-start">
              <button class="px-4 md:px-6 py-3 rounded-md flex items-center justify-center gap-2 md:gap-3 hover:scale-105 transition-all duration-200 shadow-md w-full sm:w-auto bg-gray-300 dark:bg-gray-700" style="min-width: 150px; height: 52px;">
                <svg class="w-5 h-5 fill-gray-800 dark:fill-white" viewBox="0 0 24 24">
                  <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.5,12.92 20.16,13.19L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
                </svg>
                <span class="text-gray-800 dark:text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 15px;">PlayStore</span>
              </button>
              <button class="px-6 py-3 rounded-md flex items-center gap-3 hover:scale-105 transition-all duration-200 shadow-md bg-gray-300 dark:bg-gray-700" style="width: 172px; height: 52px;">
                <svg class="w-5 h-5 fill-gray-800 dark:fill-white" viewBox="0 0 24 24">
                  <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09l.01-.01zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                </svg>
                <span class="text-gray-800 dark:text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 600; font-size: 15px;">AppleStore</span>
              </button>
            </div>
          </div>
    ...
    <section class="container mx-auto px-4 py-12 md:py-20">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center max-w-7xl mx-auto">
        <div>
          <h2 class="text-2xl md:text-4xl font-bold mb-3 md:mb-4 text-gray-800 dark:text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 700; line-height: 1.3;">Discover More About Property Rental</h2>
          <div class="w-24 md:w-36 h-1.5 rounded-full mb-6 md:mb-8 bg-gray-800 dark:bg-white"></div>
          <p class="mb-6 md:mb-8 text-sm md:text-base text-gray-600 dark:text-gray-300" style="font-family: 'Montserrat', sans-serif; font-weight: 400; line-height: 1.6;">
          ...
          <div class="flex flex-col sm:flex-row gap-4 md:gap-8 mb-6 md:mb-10">
            <button class="font-bold hover:scale-105 transition-all duration-200 text-sm md:text-base text-gray-800 dark:text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 700;">
              Ask A Question
            </button>
            <button class="font-bold hover:scale-105 transition-all duration-200 text-sm md:text-base text-gray-800 dark:text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 700;">
              Find A Property
